...
public class UserPerfCollectionsProcessor implements MessageProcessor {
  ...
  public Future<MessageResponse> process() {
    try {
      ...
      UserPerfCollectionsCommand command =
          UserPerfCollectionsCommand.builder(eventBusMessage.getRequestBody());
  ...
  private void fetchUserCollectionsPerf(UserPerfCollectionsCommand command) {
    try {
      ...
      UserPerfCollectionsModelResponse outcome =
          UserPerfCollectionsService.fetchUserCollectionsPerf(command);
