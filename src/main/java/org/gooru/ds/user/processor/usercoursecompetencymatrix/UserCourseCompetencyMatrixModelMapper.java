 ...
 */
public class UserCourseCompetencyMatrixModelMapper
    implements ResultSetMapper<UserCourseCompetencyMatrixModel> {

  @Override
  public UserCourseCompetencyMatrixModel map(int index, ResultSet r, StatementContext ctx)
      throws SQLException {
