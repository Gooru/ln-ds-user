...
interface UserSubjectPortfolioDao {
  ...
  @SqlQuery("select gut_code, collection_id, latest_session_id, collection_score, collection_type, class_id, course_id, unit_id, lesson_id, content_source, created_at, updated_at "
      + " from learner_profile_competency_evidence where collection_type IN ('assessment', 'assessment-external') AND gut_code = ANY(:gutCode) and user_id = :userId AND CAST(updated_at AS DATE) <= :dateUntil "
  ...
  @Mapper(UserSubjectPortfolioModelMapper.class)
  @SqlQuery("select gut_code, collection_id, latest_session_id, collection_score, collection_type, class_id, course_id, unit_id, lesson_id, content_source, created_at, updated_at "
      + " from learner_profile_competency_evidence where collection_type IN ('assessment', 'assessment-external') AND gut_code = ANY(:gutCode) and user_id = :userId AND CAST(updated_at AS DATE) BETWEEN :startDate AND :endDate "
      + " order by updated_at desc OFFSET :offset LIMIT :limit")
  ...
  @Mapper(UserSubjectPortfolioModelMapper.class)
  @SqlQuery("select gut_code, collection_id, latest_session_id, collection_score, collection_type, class_id, course_id, unit_id, lesson_id, content_source, created_at, updated_at "
      + " from learner_profile_competency_evidence where collection_type IN ('collection', 'collection-external') AND gut_code = ANY(:gutCode) and user_id = :userId AND CAST(updated_at AS DATE) <= :dateUntil "
      + " order by updated_at desc OFFSET :offset LIMIT :limit")
  ...
  @Mapper(UserSubjectPortfolioModelMapper.class)
  @SqlQuery("select gut_code, collection_id, latest_session_id, collection_score, collection_type, class_id, course_id, unit_id, lesson_id, content_source, created_at, updated_at "
      + " from learner_profile_competency_evidence where collection_type IN ('collection', 'collection-external') AND gut_code = ANY(:gutCode) and user_id = :userId AND CAST(updated_at AS DATE) BETWEEN :startDate AND :endDate "
      + " order by updated_at desc OFFSET :offset LIMIT :limit")
  ...
  @Mapper(UserSubjectPortfolioModelMapper.class)
  @SqlQuery("select gut_code, collection_id, latest_session_id, collection_score, collection_type, class_id, course_id, unit_id, lesson_id, content_source, created_at, updated_at "
      + " from learner_profile_competency_evidence where collection_type = 'offline-activity' AND gut_code = ANY(:gutCode) and user_id = :userId AND CAST(updated_at AS DATE) <= :dateUntil "
      + " order by updated_at desc OFFSET :offset LIMIT :limit")
  ...
  @Mapper(UserSubjectPortfolioModelMapper.class)
  @SqlQuery("select gut_code, collection_id, latest_session_id, collection_score, collection_type, class_id, course_id, unit_id, lesson_id, content_source, created_at, updated_at "
      + " from learner_profile_competency_evidence where collection_type = 'offline-activity' AND gut_code = ANY(:gutCode) and user_id = :userId AND CAST(updated_at AS DATE) BETWEEN :startDate AND :endDate "
      + " order by updated_at desc OFFSET :offset LIMIT :limit")
