...
public class UserStatsResourcesProcessor implements MessageProcessor {
  ...
  public Future<MessageResponse> process() {
    try {
      ...
      UserStatsResourcesCommand command =
          UserStatsResourcesCommand.builder(eventBusMessage.getRequestBody());
  ...
  private void fetchUserLessonPerf(UserStatsResourcesCommand command) {
    try {
      UserStatsResourcesModelResponse outcome =
          UserStatsResourceService.fetchUserResourceStats(command);
