...
public class UserStatsCoursesProcessor implements MessageProcessor {
  ...
  public Future<MessageResponse> process() {
    try {
      ...
      UserStatsCoursesCommand command =
          UserStatsCoursesCommand.builder(eventBusMessage.getRequestBody());
  ...
  private void fetchUserStatsCourses(UserStatsCoursesCommand command) {
    try {
      UserStatsCoursesModelResponse outcome =
          userStatsCoursesService.fetchUserStatsCourses(command);
