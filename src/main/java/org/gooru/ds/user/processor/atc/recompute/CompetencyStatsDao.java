...
interface CompetencyStatsDao {
	...
	List<CompetencyStatsModel> fetchGradeCompetencyStats(@Bind("user") PGArray<String> user, @Bind("classId") String classId,
	...
	List<CompetencyStatsModel> fetchGradeCompetencyStatsTimeBound(@Bind("user") PGArray<String> user,
			@Bind("classId") String classId, @Bind("subjectCode") String subjectCode, @Bind("month") Integer month,
