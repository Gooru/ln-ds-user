...
public class UserStatsCuratorProcessor implements MessageProcessor {
    ...
    public Future<MessageResponse> process() {
        try {
            ...
            UserStatsCuratorCommand command = UserStatsCuratorCommand.builder(eventBusMessage.getRequestBody());
    ...
    private void fetchUserStatsCurator(UserStatsCuratorCommand command) {
        try {
            UserStatsCuratorModelResponse outcome = userStatsCuratorService.fetchUserStatsCurator(command);
