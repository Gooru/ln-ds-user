...
public class UserCompetencyMatrixProcessor implements MessageProcessor {
    ...
    public Future<MessageResponse> process() {
        try {
            ...
            UserCompetencyMatrixCommand command = UserCompetencyMatrixCommand.builder(eventBusMessage.getRequestBody());
    ...
    private void fetchUserCompetencyMatrix(UserCompetencyMatrixCommand command) {
        try {
            UserCompetencyMatrixModelResponse outcome = userCompetencyMatrixService.fetchUserCompetencyMatrix(command);
