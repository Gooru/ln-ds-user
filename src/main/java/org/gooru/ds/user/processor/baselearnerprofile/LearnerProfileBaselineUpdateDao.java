...
public abstract class LearnerProfileBaselineUpdateDao {
	...
	protected abstract void UpdateLearnerBaselineProfile(@BindBean List<LearnerProfileReadModel> models, @Bind("classId") String classId, 
	...
	protected abstract void UpdateLearnerBaselineProfileForIL(@BindBean List<LearnerProfileReadModel> models, 
			@Bind("courseId") String courseId,   
			@Bind("createdAt") Timestamp createdAt);
}
