...
public class GradeBoundaryListProcessor implements MessageProcessor {
  ...
  private final GradeBoundaryListService service =
      new GradeBoundaryListService(DBICreator.getDbiForDefaultDS());
  ...
  public Future<MessageResponse> process() {
    try {
      ...
      GradeBoundaryListCommand command =
          GradeBoundaryListCommand.builder(this.eventBusMessage.getRequestBody());
