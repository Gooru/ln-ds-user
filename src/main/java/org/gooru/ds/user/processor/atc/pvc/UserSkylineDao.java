...
interface UserSkylineDao {
  ...
  List<UserSkylineModel> fetchUserSkyline(@Bind("user") String user,
  ...
  List<UserSkylineModel> fetchUserSkylineMonthBased(@Bind("user") String user,
      @Bind("subjectCode") String subjectCode, @Bind("month") Integer month,
