...
class UserJourneyService {
  ...
  private List<UserJourneyModel> fetchClassJourneys(UserJourneyCommand command,
  ...
  private List<UserJourneyModel> fetchILJourneys(UserJourneyCommand command,
      List<String> courseIds) {
    if (!courseIds.isEmpty()) {
      return userJourneyDao.fetchUserILJourney(command.asBean(),
          PGArrayUtils.convertFromListStringToSqlArrayOfString(courseIds));
