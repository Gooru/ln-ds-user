...
public class GradeBasedCompetencyStatsProcessor implements MessageProcessor {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(GradeBasedCompetencyStatsProcessor.class);
    ...
    private void fetchUserCompetencyStats(GradeBasedCompetencyStatsCommand command) {
        try {
            CompetencyStatsResponse response = competencyStatsService.fetchUserGradeCompetencyStats(command);
