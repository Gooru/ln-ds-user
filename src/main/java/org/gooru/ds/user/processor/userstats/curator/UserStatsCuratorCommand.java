 ...
 */
class UserStatsCuratorCommand {
    private String activeDuration;
    private String user;

    private static final Logger LOGGER = LoggerFactory.getLogger(UserStatsCuratorCommand.class);
    ...
    static UserStatsCuratorCommand builder(JsonObject requestBody) {
        UserStatsCuratorCommand result = UserStatsCuratorCommand.buildFromJsonObject(requestBody);
        result.validate();
        return result;
    }

    public UserStatsCuratorsCommandBean asBean() {
        UserStatsCuratorsCommandBean bean = new UserStatsCuratorsCommandBean();
        bean.user = user;
        bean.activeDuration = activeDuration;
        return bean;
    }

    private static UserStatsCuratorCommand buildFromJsonObject(JsonObject requestBody) {
        UserStatsCuratorCommand result = new UserStatsCuratorCommand();
    ...
    public static class UserStatsCuratorsCommandBean {
        private String activeDuration;
        private String user;
