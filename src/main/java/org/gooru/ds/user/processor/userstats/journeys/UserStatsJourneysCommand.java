 ...
 */
class UserStatsJourneysCommand {
  private String activeDuration;
  private String user;

  private static final Logger LOGGER = LoggerFactory.getLogger(UserStatsJourneysCommand.class);
  ...
  static UserStatsJourneysCommand builder(JsonObject requestBody) {
    UserStatsJourneysCommand result = UserStatsJourneysCommand.buildFromJsonObject(requestBody);
    result.validate();
    return result;
  }

  public UserStatsJourneysCommandBean asBean() {
    UserStatsJourneysCommandBean bean = new UserStatsJourneysCommandBean();
    bean.user = user;
    bean.activeDuration = activeDuration;
    return bean;
  }

  private static UserStatsJourneysCommand buildFromJsonObject(JsonObject requestBody) {
    UserStatsJourneysCommand result = new UserStatsJourneysCommand();
  ...
  public static class UserStatsJourneysCommandBean {
    private String activeDuration;
    private String user;
