...
public interface CompetencyLine {
  ...
  /**
   * Compute the collection of Competencies from this Competency line to specified competency line
   *
   * @param competencyLine The destination or target Competency line
   * @return Competencies till this highline
   */
  CompetencyCollector getAllCompetenciesTillCompetencyLine(CompetencyLine competencyLine);
