...
class LearnerPrefsCommand {
  ...
  public LearnerPrefsCommandBean asBean() {
  ...
  static LearnerPrefsCommand builder(JsonObject requestBody) {
    LearnerPrefsCommand result = LearnerPrefsCommand.buildFromJsonObject(requestBody);
    result.validate();
    return result;
  }
