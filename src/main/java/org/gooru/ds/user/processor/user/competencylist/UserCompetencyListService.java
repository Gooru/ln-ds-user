...
public class UserCompetencyListService {
  ...
  public UserCompetencyListModelResponse fetchUserCompetencyList(
      UserCompetencyListCommand command) {
    List<UserCompetencyListModel> models =
        userCompetencyListDao.fetchUserCompetencyList(command.asBean());
