...
public class UserPerfCompetencyAssessmentsCommand {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(UserPerfCompetencyAssessmentsCommand.class);
    ...
    static UserPerfCompetencyAssessmentsCommand builder(JsonObject requestBody) {
        UserPerfCompetencyAssessmentsCommand result = UserPerfCompetencyAssessmentsCommand.buildFromJsonObject(requestBody);
        result.validate();
        return result;
    }
