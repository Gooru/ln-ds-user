...
interface UserPerfCourseDao {
    ...
    @SqlQuery(
        "select distinct on (unit_id) unit_id, class_id, class_code, class_title, course_id, course_title, "
            + "course_asmt_time_spent, course_asmt_score, course_coll_time_spent, "
            + "unit_id, unit_title, unit_asmt_time_spent, unit_asmt_score, unit_coll_time_spent, "
            + "course_assessments_complete, total_assessments"
