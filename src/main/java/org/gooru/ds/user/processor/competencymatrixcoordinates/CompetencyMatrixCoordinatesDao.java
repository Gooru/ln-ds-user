...
interface CompetencyMatrixCoordinatesDao {
  ...
  List<CompetencyMatrixCoordinatesCourseModel> fetchCompetencyMatrixCoordinatesCourses(
      @BindBean CompetencyMatrixCoordinatesCommand.CompetencyMatrixCoordinatesCommandBean competencyMatrixCoordinatesCommandBean);
  ...
  List<CompetencyMatrixCoordinatesDomainModel> fetchCompetencyMatrixCoordinatesDomains(
      @BindBean CompetencyMatrixCoordinatesCommand.CompetencyMatrixCoordinatesCommandBean competencyMatrixCoordinatesCommandBean);
