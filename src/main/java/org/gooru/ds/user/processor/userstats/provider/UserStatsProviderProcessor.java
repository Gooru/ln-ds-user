...
public class UserStatsProviderProcessor implements MessageProcessor {
    ...
    public Future<MessageResponse> process() {
        try {
            ...
            UserStatsProviderCommand command = UserStatsProviderCommand.builder(eventBusMessage.getRequestBody());
    ...
    private void fetchUserStatsProvider(UserStatsProviderCommand command) {
        try {
            UserStatsProviderModelResponse outcome = userStatsProviderService.fetchUserStatsProvider(command);
