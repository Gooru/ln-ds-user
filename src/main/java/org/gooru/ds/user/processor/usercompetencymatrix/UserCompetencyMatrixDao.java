...
interface UserCompetencyMatrixDao {
    ...
    @SqlQuery("select cm.tx_course_code, cm.tx_domain_code, cm.tx_comp_code, cm.tx_comp_name, cm.tx_comp_desc, cm"
                  ...
                  + "user_competency_matrix ucm on  cm.tx_subject_code = ucm.tx_subject_code and cm.tx_comp_code = "
                  + "ucm.tx_comp_code and ucm.user_id = :user where cm.tx_subject_code = :subject order by cm"
