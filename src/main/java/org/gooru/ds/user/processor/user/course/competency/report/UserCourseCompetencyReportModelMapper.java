 ...
 */
public class UserCourseCompetencyReportModelMapper implements ResultSetMapper<UserCourseCompetencyReportModel>{

	@Override
	public UserCourseCompetencyReportModel map(int index, ResultSet r, StatementContext ctx) throws SQLException {
