 ...
 * @author mukul@gooru
 */
public class UserPerfCompetencyAssessmentsModelMapper implements ResultSetMapper<UserPerfCompetencyAssessmentsModel> {

    @Override
    public UserPerfCompetencyAssessmentsModel map(int index, ResultSet r, StatementContext ctx) throws SQLException {
