...
import org.gooru.ds.user.processor.user.journey.UserJourneyModelMapper;
...
interface UserJourneyDao {
    ...
    @SqlQuery("select class_id, class_code, class_title, course_id, course_title, "
    		...
    		+ "from overall_course_performance where "
    		+ "class_id = any(:classIds) ")
    List<UserJourneyModel> fetchUserClassJourney(@BindBean UserJourneyCommand.UserJourneyCommandBean userJourneyCommandBean, 
    ...
    List<UserJourneyModel> fetchUserILJourney(@BindBean UserJourneyCommand.UserJourneyCommandBean userJourneyCommandBean,  
