...
public class UserPerfCompetencyCollectionsCommand {
  ...
  private static final Logger LOGGER =
      LoggerFactory.getLogger(UserPerfCompetencyCollectionsCommand.class);
  ...
  static UserPerfCompetencyCollectionsCommand builder(JsonObject requestBody) {
    UserPerfCompetencyCollectionsCommand result =
        UserPerfCompetencyCollectionsCommand.buildFromJsonObject(requestBody);
    result.validate();
    return result;
  }
