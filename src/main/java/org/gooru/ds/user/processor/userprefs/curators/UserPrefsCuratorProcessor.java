...
public class UserPrefsCuratorProcessor implements MessageProcessor {
  ...
  public Future<MessageResponse> process() {
    try {
      ...
      UserPrefsCuratorCommand command =
          UserPrefsCuratorCommand.builder(eventBusMessage.getRequestBody());
  ...
  private void fetchUserPrefsCurator(UserPrefsCuratorCommand command) {
    try {
      UserPrefsCuratorModelResponse outcome =
          userPrefsCuratorService.fetchUserPrefsCurator(command);
