...
class CompetencyMapImpl implements CompetencyMap {
  ...
  CompetencyMapImpl(List<Competency> competencies) {
    ...
    for (Competency competency : competencies) {
      List<Competency> competenciesForDomain =
          domainCodeCompetencyListMap.get(competency.getDomain());
  ...
  public String toString() {
    return "CompetencyMap{" + "domains=" + domains + ", domainCodeCompetencyListMap="
        + domainCodeCompetencyListMap + ", ceilingLine=" + ceilingLine + ", floorLine=" + floorLine
        + '}';
  }
}
