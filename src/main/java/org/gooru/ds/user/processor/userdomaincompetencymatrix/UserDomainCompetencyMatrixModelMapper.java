 ...
 */
public class UserDomainCompetencyMatrixModelMapper implements ResultSetMapper<UserDomainCompetencyMatrixModel> {

    @Override
    public UserDomainCompetencyMatrixModel map(int index, ResultSet r, StatementContext ctx) throws SQLException {
