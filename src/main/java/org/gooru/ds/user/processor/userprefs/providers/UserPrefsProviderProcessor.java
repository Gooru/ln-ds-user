...
public class UserPrefsProviderProcessor implements MessageProcessor {
  ...
  public Future<MessageResponse> process() {
    try {
      ...
      UserPrefsProviderCommand command =
          UserPrefsProviderCommand.builder(eventBusMessage.getRequestBody());
  ...
  private void fetchUserPrefsProvider(UserPrefsProviderCommand command) {
    try {
      UserPrefsProviderModelResponse outcome =
          userPrefsProviderService.fetchUserPrefsProvider(command);
