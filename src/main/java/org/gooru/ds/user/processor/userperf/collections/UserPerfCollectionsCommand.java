...
public class UserPerfCollectionsCommand {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(UserPerfCollectionsCommand.class);
    ...
    static UserPerfCollectionsCommand builder(JsonObject requestBody) {
        UserPerfCollectionsCommand result = UserPerfCollectionsCommand.buildFromJsonObject(requestBody);
        result.validate();
        return result;
    }

    public UserPerfCollectionsCommandBean asBean() {
        UserPerfCollectionsCommandBean bean = new UserPerfCollectionsCommandBean();
        bean.user = user;
    ...
    private static UserPerfCollectionsCommand buildFromJsonObject(JsonObject requestBody) {
        UserPerfCollectionsCommand result = new UserPerfCollectionsCommand();
    ...
    public static class UserPerfCollectionsCommandBean {
        private String classId;
        private String courseId;
        private String unitId;
        private String lessonId;
