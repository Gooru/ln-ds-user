...
interface UserPerfAssessmentsDao {
    ...
    @SqlQuery("select collection_id, collection_title, latest_session_id, collection_time_spent, collection_score, collection_average_reaction"
    ...
    List<UserPerfAssessmentsModel> fetchUserPerfAssessments (@BindBean UserPerfAssessmentsCommand.UserPerfAssessmentsCommandBean userPerfAssessmentsCommandBean);
