...
interface UserPerfAssessmentsDao {
    ...
    @SqlQuery(
        "select collection_id, collection_title, collection_time_spent, collection_score, collection_average_reaction"
    ...
    UserPerfAssessmentsModel fetchUserPerfAssessments(
