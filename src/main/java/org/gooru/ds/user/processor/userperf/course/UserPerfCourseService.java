...
import org.gooru.ds.user.processor.userperf.course.UserPerfCourseDao;
 ...
 * @author mukul@gooru
 */
public class UserPerfCourseService {
    ...
    public List<UserPerfCourseBaseModel> fetchUserCoursePerf(UserPerfCourseCommand command) {
        List<UserPerfCourseBaseModel> result = new ArrayList();
