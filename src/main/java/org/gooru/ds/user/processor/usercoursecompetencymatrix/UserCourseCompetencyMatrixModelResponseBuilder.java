...
import static org.gooru.ds.user.processor.usercoursecompetencymatrix.UserCourseCompetencyMatrixModelResponse.UserCompetencyMatrixCompetencyModelResponse;
import static org.gooru.ds.user.processor.usercoursecompetencymatrix.UserCourseCompetencyMatrixModelResponse.UserCompetencyMatrixCourseModelResponse;
...
final class UserCourseCompetencyMatrixModelResponseBuilder {
  ...
  /*
   * Does the response creation from models. Note that models are supposed to be ordered by course.
   * This logic works off change of domain and/or course
   */
  public static UserCourseCompetencyMatrixModelResponse build(
      List<UserCourseCompetencyMatrixModel> models, Timestamp lastUpdated) {
    UserCourseCompetencyMatrixModelResponse response =
        new UserCourseCompetencyMatrixModelResponse();
