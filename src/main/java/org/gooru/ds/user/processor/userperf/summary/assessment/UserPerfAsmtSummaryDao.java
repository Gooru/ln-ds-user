...
import org.gooru.ds.user.processor.userperf.summary.assessment.UserPerfAsmtSummaryModelMapper;
...
interface UserPerfAsmtSummaryDao {
    ...
    List<UserPerfAsmtSummaryModel> fetchUserPerfAsmtSummary (@BindBean UserPerfAsmtSummaryCommand.UserPerfAsmtSummaryCommandBean userPerfAsmtSummaryCommandBean);
