 ...
 * 
 */
public class CompetencySubjectListModelMapper implements ResultSetMapper<CompetencySubjectListModel> {
	
    @Override
    public CompetencySubjectListModel map(int index, ResultSet r, StatementContext ctx) throws SQLException {
