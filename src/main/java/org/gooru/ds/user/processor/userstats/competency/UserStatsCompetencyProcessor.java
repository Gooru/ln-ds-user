...
public class UserStatsCompetencyProcessor implements MessageProcessor {
    ...
    public Future<MessageResponse> process() {
        try {
            ...
            UserStatsCompetencyCommand command = UserStatsCompetencyCommand.builder(eventBusMessage.getRequestBody());
    ...
    private void fetchUserStatsCompetency(UserStatsCompetencyCommand command) {
        try {
            UserStatsCompetencyModel outcome = userStatsCompetencyService.fetchUserStatsCompetency(command);
