...
public class UserPerfCompetencyAssessmentsProcessor implements MessageProcessor {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(UserPerfCompetencyAssessmentsProcessor.class);
    ...
    public Future<MessageResponse> process() {
        try {
            ...
            UserPerfCompetencyAssessmentsCommand command = UserPerfCompetencyAssessmentsCommand.builder(eventBusMessage.getRequestBody());
    ...
    private void fetchUserAssessmentsPerf(UserPerfCompetencyAssessmentsCommand command) {
        try {
            UserPerfCompetencyAssessmentsModelResponse outcome = userPerfCompetencyAssessmentsService.fetchUserAssessmentsPerf(command);
