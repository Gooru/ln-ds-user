...
public class UserPerfAssessmentsProcessor implements MessageProcessor {
  ...
  public Future<MessageResponse> process() {
    try {
      ...
      UserPerfAssessmentsCommand command =
          UserPerfAssessmentsCommand.builder(eventBusMessage.getRequestBody());
  ...
  private void fetchUserAssessmentsPerf(UserPerfAssessmentsCommand command) {
    try {
      UserPerfAssessmentsModelResponse outcome =
          UserPerfAssessmentsService.fetchUserAssessmentsPerf(command);
