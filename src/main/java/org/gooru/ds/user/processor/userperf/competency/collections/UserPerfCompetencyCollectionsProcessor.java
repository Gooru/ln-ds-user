...
public class UserPerfCompetencyCollectionsProcessor implements MessageProcessor {
  ...
  private static final Logger LOGGER =
      LoggerFactory.getLogger(UserPerfCompetencyCollectionsProcessor.class);
  ...
  public Future<MessageResponse> process() {
    try {
      ...
      UserPerfCompetencyCollectionsCommand command =
          UserPerfCompetencyCollectionsCommand.builder(eventBusMessage.getRequestBody());
  ...
  private void fetchUserCollectionsPerf(UserPerfCompetencyCollectionsCommand command) {
    try {
      UserPerfCompetencyCollectionsModelResponse outcome =
          userPerfCompetencyCollectionsService.fetchUserCollectionsPerf(command);
