...
import org.gooru.ds.user.app.components.helpers.DatasourceHelper;
...
public final class DataSourceRegistry implements Initializer, Finalizer {
    ...
    // that key
    private final List<String> datasources = Arrays.asList(DEFAULT_DATA_SOURCE, ANALYTICS_DATA_SOURCE, CORE_DATA_SOURCE);
