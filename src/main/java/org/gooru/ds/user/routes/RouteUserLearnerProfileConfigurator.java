...
public class RouteUserLearnerProfileConfigurator implements RouteConfigurator {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(RouteUserLearnerProfileConfigurator.class);
	...
	public void configureRoutes(Vertx vertx, Router router, JsonObject config) {
		...
		router.get(Constants.Route.API_USER_BASELINE_LEARNER_PROFILE).handler(this::baselineLearnerProfile);
	}

	private void baselineLearnerProfile(RoutingContext routingContext) {
		RouteHandlerUtils.baseHandler(eb, routingContext, Constants.Message.MSG_OP_READ_BASELINE_LEARNER_PROFILE,
