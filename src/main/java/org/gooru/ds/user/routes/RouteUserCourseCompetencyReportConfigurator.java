...
public class RouteUserCourseCompetencyReportConfigurator implements RouteConfigurator {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(RouteUserCourseCompetencyReportConfigurator.class);
	...
	public void configureRoutes(Vertx vertx, Router router, JsonObject config) {
		...
		router.get(Constants.Route.API_USER_COURSE_COMPETENCY_REPORT).handler(this::userCompetencyReport);
	}

	private void userCompetencyReport(RoutingContext routingContext) {
		RouteHandlerUtils.baseHandler(eb, routingContext, Constants.Message.MSG_OP_USER_COURSE_COMPETENCY_REPORT,
