...
public class RouteNavigatorCourseConfigurator implements RouteConfigurator {
    ...
    private void userPvC(RoutingContext routingContext) {
        RouteHandlerUtils
            .baseHandler(eb, routingContext, Constants.Message.MSG_OP_USERS_PERF_VS_COMPLETION, Constants.EventBus.MBEP_DISPATCHER,
                mbusTimeout, LOGGER);
    }

    private void userATC(RoutingContext routingContext) {
        RouteHandlerUtils
            .baseHandler(eb, routingContext, Constants.Message.MSG_OP_ATC, Constants.EventBus.MBEP_DISPATCHER,
                mbusTimeout, LOGGER);
    }
}
